      ...
      <div className="relative">
        ...
        <div className="absolute top-[3.5%] left-[11.5%] w-[77%] h-[70%] overflow-hidden">
          <div className="h-full bg-white">
            ...
            <div className="h-full px-6 pb-8 pt-5 overflow-y-auto">
              
              <div className='flex justify-center'><img src="/Images/logo.png" alt="Sagan Logo" className="w-60 pb-4 " /></div>
                ...
                {shuffledImages.map((image, index) => (
                  ...
                  >
                    <img
                      src={image.src}
                      alt={image.alt}
                      className="object-cover w-full h-[265px] transition-transform duration-300 group-hover:scale-105"
                      loading="lazy"
                    />
                  </div>
                ))}

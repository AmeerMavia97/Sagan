...
const HomeTradition = () => {
  return (
    <>
      <section className="px-4 py-12 bg-white md:px-12">
        <div className="flex flex-col items-center gap-10 mx-auto max-w-7xl md:flex-row">
          ...
          <div className="w-full text-center md:w-1/2 md:text-left">
            <h2 className="mb-4 text-2xl font-extrabold leading-tight text-gray-900 font-right-grotesk sm:text-3xl md:text-4xl uppercase">
              Honoring Traditions, <br className="hidden sm:block" />
              Digitally.
            </h2>
            <p className="text-base text-[15px] text-black sm:leading-relaxed sm:text-gray-900 sm:text-lg font-space-grotesk">

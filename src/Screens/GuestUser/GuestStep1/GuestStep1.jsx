...
const handleContinue = () => {
    ...
    return (
        <>
            <section className='bg-[#FFF5F7] rounded-2xl grid grid-cols-2 px-20 mb-12 2xl:my-0 py-16 '>
                <div className='flex justify-center flex-col items-center gap-4  py-20'>
                    <img className='w-[80%] 2xl:w-[70%]' src="/Images/VerticalLogo.png" alt="" />
                ...
                <div className='flex flex-col justify-center items-center text-center gap-6 px-20'>
                    <h1 className='font-Inter text-[19px] 2xl:text-[25px] font-semibold'>Add a personalized video or message</h1>
                    <div className='py-5'>

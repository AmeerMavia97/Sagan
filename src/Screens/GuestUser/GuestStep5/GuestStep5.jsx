...
const GuestStep5 = () => {
    ...
    return (
        <>
            <section className='grid grid-cols-1 w-full pt-10 pb-20 2xl:py-20'>
                <div className='flex flex-col justify-center items-center gap-7 2xl:gap-10'>
                    <div className='flex justify-center items-center'>
                        <img className='w-[18%] 2xl:w-[18%]' src="Images/events/SaganEnvelop.jpeg" alt="" />
                    </div>

                    <div className='flex flex-col gap-3 justify-center items-center'>
                        <h1 className='font-Inter text-[23px] 2xl:text-[30px] font-semibold text-[#272727]'>Sagan Sent!</h1>
                    ...
                    <div className='border-t-[1px] border-[#a3a3a3] w-[60%] 2xl:w-[70%] flex justify-center pt-6 2xl:pt-9'>
                        <p className='font-Inter text-center text-[15px] 2xl:text-[22px] font-semibold text-[#7E7E7E]'>We’ve emailed your receipt</p>
                    </div>
                </div>

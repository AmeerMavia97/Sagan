...
const Register = ({ onSuccess }) => {
 ...
 const onSubmit = (data) => {
  ...
  // If email verification step is active, show only that screen
  if (Show) {
    return <VerifiedEmail />;
  }

    return (
        <section className='bg-[#ffb5c085] fixed top-0 w-full min-h-screen z-50 flex justify-center items-center'>
